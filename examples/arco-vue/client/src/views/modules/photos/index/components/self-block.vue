...
<template>
  <div>
    <a-card :title="$t('photos--index.self-block.title')" class="da-table-block dac-self-block">
...
<script lang="ts" setup>
  ...
  import { Model, ListRequest, list } from '@/api/modules/photos/index/self-block';
