...
<template>
  <div>
    <a-card :title="$t('tables--index.object-array-block.title')" class="da-table-block dac-object-array-block">
      ...
      >
        <template #object_arr="{ record, column }">
          <DullTable
...
<script lang="ts" setup>
  ...
  import { Model, ListRequest, list } from '@/api/modules/tables/index/object-array-block';
  ...
  const modelMetadata: { [key: string]: any } = {
    object_arr: {
      ...
      attributes: {
        id: {
          type: 'int64',
          i18nKey: 'tables--index.object-array-block.model.attributes.object_arr.id',
        },
        name: {
          type: 'string',
          i18nKey: 'tables--index.object-array-block.model.attributes.object_arr.name',
        },
        role: {
          type: 'string',
          i18nKey: 'tables--index.object-array-block.model.attributes.object_arr.role',
          optionals: {
            admin: {
              i18nKey: 'tables--index.object-array-block.model.attributes.object_arr.role.optionals.admin',
            },
            user: {
              i18nKey: 'tables--index.object-array-block.model.attributes.object_arr.role.optionals.user',
            },
          },
        },
      }
  ...
  const tableColumns = computed<Column[]>(() => {
    return ([
      {
        title: t('tables--index.object-array-block.model.attributes.object_arr'),
        dataIndex: 'object_arr',
        slotName: 'object_arr',
        cellClass: 'column-object_arr',
        hidden: false,
      },
      {
