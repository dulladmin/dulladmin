    ...
    object_arr: {
      ...
      attributes: {
        ...
        role: {
          ...
          optionals: {
            admin: {
              i18nKey: 'descriptions--index.object-array-block.model.attributes.object_arr.role.optionals.admin',
            },
            user: {
              i18nKey: 'descriptions--index.object-array-block.model.attributes.object_arr.role.optionals.user',
            },
          },
        },
      }
