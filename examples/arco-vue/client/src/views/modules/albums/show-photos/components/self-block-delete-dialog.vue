...
<template>
  <a-modal
    ...
    class="da-form-dialog dac-self-block-delete-dialog"
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/albums/show-photos/self-block-delete-dialog';
