              ...
              <tbody>
                <tr class="arco-descriptions-row">
                  <td class="arco-descriptions-item-label arco-descriptions-item-label-block">
                    {{ $t('albums--show-photos.self-block.show-dialog.model.attributes.title') }}
                  </td>
                ...
                <tr class="arco-descriptions-row">
                  <td class="arco-descriptions-item-label arco-descriptions-item-label-block">
                    {{ $t('albums--show-photos.self-block.show-dialog.model.attributes.url') }}
                  </td>
                  <td class="arco-descriptions-item-value arco-descriptions-item-value-block">
                    <DullData
                      :data="store.url"
                ...
                <tr class="arco-descriptions-row">
                  <td class="arco-descriptions-item-label arco-descriptions-item-label-block">
                    {{ $t('albums--show-photos.self-block.show-dialog.model.attributes.thumbnailUrl') }}
                  </td>
                  <td class="arco-descriptions-item-value arco-descriptions-item-value-block">
                    <DullData
...
<script lang="ts" setup>
  ...
  import { Model, get } from '@/api/modules/albums/show-photos/self-block-show-dialog';
  ...
  const modelMetadata: { [key: string]: any } = {
    title: {
      type: 'string',
      i18nKey: 'albums--show-photos.self-block.show-dialog.model.attributes.title',
    },
    url: {
      type: 'image',
      i18nKey: 'albums--show-photos.self-block.show-dialog.model.attributes.url',
    },
    thumbnailUrl: {
      type: 'image',
      i18nKey: 'albums--show-photos.self-block.show-dialog.model.attributes.thumbnailUrl',
    },
  };
