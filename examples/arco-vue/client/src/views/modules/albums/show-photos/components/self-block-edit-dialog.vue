...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/albums/show-photos/self-block-edit-dialog';
  ...
  const modelMetadata: { [key: string]: any } = {
    title: {
      type: 'string',
      hidden: false,
      i18nKey: 'albums--show-photos.self-block.edit-dialog.model.attributes.title',
    },
  };
