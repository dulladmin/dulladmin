...
<template>
  <a-modal
    ...
    class="da-form-dialog dac-self-block-new-dialog"
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/albums/show-photos/self-block-new-dialog';
  ...
  const modelMetadata: { [key: string]: any } = {
    title: {
      type: 'string',
      hidden: false,
      i18nKey: 'albums--show-photos.self-block.new-dialog.model.attributes.title',
    },
  };
