...
<template>
  <div>
    <a-card :title="$t('users--new.self-block.title')" class="da-form-block dac-self-block">
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/users/new/self-block';
  ...
  const modelMetadata: { [key: string]: any } = {
    name: {
      type: 'string',
      hidden: false,
      i18nKey: 'users--new.self-block.model.attributes.name',
    },
    username: {
      type: 'string',
      hidden: false,
      i18nKey: 'users--new.self-block.model.attributes.username',
    },
    avatar: {
      type: 'image',
      hidden: false,
      i18nKey: 'users--new.self-block.model.attributes.avatar',
    },
    email: {
      type: 'string',
      hidden: false,
      i18nKey: 'users--new.self-block.model.attributes.email',
    },
    phone: {
      type: 'string',
      hidden: false,
      i18nKey: 'users--new.self-block.model.attributes.phone',
    },
    website: {
      type: 'string',
      hidden: false,
      i18nKey: 'users--new.self-block.model.attributes.website',
    },
  };
