...
<template>
  <div>
    <a-card :title="$t('posts--show.self-block.title')" class="da-descriptions-block dac-self-block">
              ...
              <tbody>
                <tr class="arco-descriptions-row">
                  <td class="arco-descriptions-item-label arco-descriptions-item-label-block">
                    {{ $t('posts--show.self-block.model.attributes.userId') }}
                  </td>
                ...
                <tr class="arco-descriptions-row">
                  <td class="arco-descriptions-item-label arco-descriptions-item-label-block">
                    {{ $t('posts--show.self-block.model.attributes.title') }}
                  </td>
                  <td class="arco-descriptions-item-value arco-descriptions-item-value-block">
                    <DullData
                      :data="store.title"
                ...
                <tr class="arco-descriptions-row">
                  <td class="arco-descriptions-item-label arco-descriptions-item-label-block">
                    {{ $t('posts--show.self-block.model.attributes.body') }}
                  </td>
                  <td class="arco-descriptions-item-value arco-descriptions-item-value-block">
                    <DullData
                      :data="store.body"
...
<script lang="ts" setup>
  ...
  import { Model, get } from '@/api/modules/posts/show/self-block';
  ...
  const modelMetadata: { [key: string]: any } = {
    userId: {
      type: 'int64',
      i18nKey: 'posts--show.self-block.model.attributes.userId',
    },
    title: {
      type: 'string',
      i18nKey: 'posts--show.self-block.model.attributes.title',
    },
    body: {
      type: 'string',
      i18nKey: 'posts--show.self-block.model.attributes.body',
    },
  };
