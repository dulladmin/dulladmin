...
<template>
  <div>
    <a-card :title="$t('todos--new.self-block.title')" class="da-form-block dac-self-block">
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/todos/new/self-block';
  ...
  const modelMetadata: { [key: string]: any } = {
    ...
    title: {
      type: 'string',
      hidden: false,
      i18nKey: 'todos--new.self-block.model.attributes.title',
    },
    completed: {
      type: 'bool',
      hidden: false,
      i18nKey: 'todos--new.self-block.model.attributes.completed',
    },
  };
