...
<template>
  <a-modal
    ...
    class="da-form-dialog dac-self-block-create-completed-dialog"
  ...
  >
    <template #title>
      ...
      -
      {{ $t('todos--index.self-block.create-completed-dialog.title') }}
    </template>
    <div>
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/todos/index/self-block-create-completed-dialog';
