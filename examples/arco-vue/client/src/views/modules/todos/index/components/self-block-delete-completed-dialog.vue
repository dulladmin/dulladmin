...
<template>
  <a-modal
    ...
    class="da-form-dialog dac-self-block-delete-completed-dialog"
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/todos/index/self-block-delete-completed-dialog';
