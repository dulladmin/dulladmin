...
<template>
  <div>
    <a-card :title="$t('todos--delete.self-block.title')" class="da-form-block dac-self-block">
...
<script lang="ts" setup>
  ...
  import { FormModel, UpdateRequest, get, update } from '@/api/modules/todos/delete/self-block';
